...
View this technote at http://dmtn-010.lsst.io or see a preview of the
...
.. code-block:: bash
   ...
   git clone https://github.com/lsst-dm/dmtn-010
   cd dmtn-010
...
The published technote at http://dmtn-010.lsst.io will be automatically rebuilt whenever you push your changes to the ``master`` branch on `GitHub <https://github.com/lsst-dm/dmtn-010>`_.
